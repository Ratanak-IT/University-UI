...
export default function Hero() {
  return (
    <section className="w-full bg-background overflow-hidden py-12 md:py-16">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid grid-cols-1 items-center gap-12 md:grid-cols-2">
        ...
        <motion.div
          ...
          className="relative mx-auto flex h-[380px] w-[380px] sm:h-[420px] sm:w-[420px] max-w-full items-center justify-center"
        >
          {/* Rotating Border */}
          <motion.div
            animate={{ rotate: 360 }}
          ...
          <motion.img
            ...
            className="relative z-10 h-64 w-64 sm:h-72 sm:w-72 rounded-full object-cover shadow-2xl"
          />
        </motion.div>
