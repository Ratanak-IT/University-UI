        ...
        <div className="flex flex-col gap-6">
          ...
          <Card className="p-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                <div className="w-16 h-16 rounded-full overflow-hidden bg-muted flex items-center justify-center ring-1 ring-border">
                ...
                <div>
                  ...
                  <div className="mt-1.5 flex items-center gap-2 text-xs">
                    ...
                    <span className="text-muted-foreground">Joined 2 years ago</span>
                  </div>
                </div>
              </div>
              <button className="inline-flex items-center gap-1.5 rounded-lg bg-primary hover:opacity-90 transition-colors text-primary-foreground text-sm font-medium px-4 py-2.5">
                Edit Profile
          ...
          <Card className="p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-5">
              ...
              <div>
                ...
                <div className="flex items-center justify-between rounded-lg border border-border px-3 py-2.5 text-sm text-card-foreground">
          ...
          <Card className="p-6">
            ...
            <div className="mb-5">
              ...
              <div className="rounded-lg border border-border px-3 py-2.5 text-sm text-card-foreground">
            ...
            <div>
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                <button className="inline-flex items-center gap-1.5 rounded-lg border border-dashed border-border px-3 py-1.5 text-sm font-medium text-muted-foreground hover:bg-muted">
        ...
        <div className="flex flex-col gap-6">
          ...
          <Card className="p-5">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between text-xs">
                <span className="text-muted-foreground">Keycloak Sub Claim ID</span>
              ...
              <div className="flex items-center justify-between text-xs">
                ...
                <span className="text-muted-foreground font-mono">8901224</span>
              </div>
            </div>
          </Card>
          ...
          <div className="grid grid-cols-2 gap-4">
            <Card className="p-4 bg-primary/5 border-primary/15">
              <p className="text-xs font-medium text-primary">Students</p>
              <p className="text-2xl font-bold text-primary mt-1">142</p>
            </Card>
            <Card className="p-4 bg-pink-50/60 border-pink-100 dark:bg-pink-950/30 dark:border-pink-900">
              <p className="text-xs font-medium text-pink-700 dark:text-pink-300">Publications</p>
              <p className="text-2xl font-bold text-pink-900 mt-1 dark:text-pink-200">28</p>
            </Card>
          </div>
        </div>
      </div>
