    ...
    <section className="ums-section-gradient py-28">
      <div className="mx-auto max-w-[1320px] px-6 lg:px-8">
        <div className="mx-auto max-w-xl text-center">
          ...
          <p className="mt-5 text-[15px] leading-[1.7] text-gray-500">Explore high-quality, expert-led courses designed to help you grow your skills and advance your career.</p>
        </div>

        <div className="mt-12 flex flex-wrap justify-center gap-x-10 gap-y-3 border-b border-[#e9f1fe]">
          {TABS.map((t, i) => (
            <button key={t} type="button" onClick={() => setActive(i)} className={`-mb-px border-b-2 pb-4 text-[17px] transition-colors ${active === i ? "border-brandblue text-brandblue" : "border-transparent text-gray-500 hover:text-ink"}`}>
              {t}
            </button>
          ))}
        </div>
        ...
        <div className="mx-auto mt-10 max-w-xl text-center">
          <p className="text-[15px] leading-[1.7] text-gray-500">Learn modern technologies through practical projects, industry mentorship, and collaborative learning environments.</p>
