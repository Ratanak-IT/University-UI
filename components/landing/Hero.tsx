...
export default function Hero() {
  return (
    <section className="ums-section-gradient relative overflow-hidden bg-background text-foreground transition-colors duration-200">
      ...
      <Image
        ...
        width={564}
        height={564}
        className="pointer-events-none absolute right-[3%] top-[10%] z-0 w-28 select-none opacity-90 sm:w-40 lg:w-44 dark:opacity-40"
      />
      ...
      <Image
        ...
        width={382}
        height={382}
        className="pointer-events-none absolute -left-10 bottom-[6%] z-0 w-32 select-none opacity-80 sm:w-40 lg:w-48 dark:opacity-40"
      />
      ...
      <div className="relative z-10 mx-auto grid max-w-[1320px] items-center gap-10 px-6 py-16 lg:grid-cols-2 lg:gap-6 lg:px-8 lg:py-20">
        ...
        <div className="relative max-w-xl">
          <svg aria-hidden className="mb-4 h-4 w-16 text-secondary" viewBox="0 0 64 16" fill="none">
          ...
          <div className="mt-8">
            <Link
              href="#courses"
              className="inline-flex items-center gap-2 rounded-[14px] bg-primary px-6 py-3.5 text-sm font-semibold text-primary-foreground transition-colors hover:bg-primary/90"
            >
              Explore Courses
          ...
          <svg aria-hidden className="mt-10 h-4 w-14 text-primary/70" viewBox="0 0 64 16" fill="none">
            <path d="M2 8c6-8 10 8 16 0s10 8 16 0 10 8 16 0" stroke="currentColor" strokeWidth="3" strokeLinecap="round" />
          </svg>
        </div>
        ...
        <div className="relative flex min-h-[420px] items-end justify-center lg:min-h-[560px]">
          <Image
            ...
            height={1280}
            priority
            className="pointer-events-none absolute right-0 top-1/2 w-[115%] max-w-none -translate-y-1/2 select-none dark:opacity-80 dark:brightness-90"
          />
          <Image
